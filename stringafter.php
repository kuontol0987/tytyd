...
<div class="row">
   <div class="col-xl-6">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Get string after</h4>
            <form id="stringafter" name="stringafter">
               <div class="mb-3">
               ...
               <div>
                  <button type="button" onclick="getStringAfterChar();" class="btn btn-primary w-md">Get</button>
               </div>
